...
{
	public Hero() { }
	public Hero(string jsonHero) : this(JsonSerializer.Deserialize<DFKContracts.HeroCore.ContractDefinition.Hero>(jsonHero)){}
	public Hero(DFKContracts.HeroCore.ContractDefinition.Hero hero)
	{
		...
		staminaFullAt = long.Parse(hero.State.StaminaFullAt.ToString());
